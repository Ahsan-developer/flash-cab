                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="service-item wow fadeInUp">
                        ...
                        <div class="service-footer">
                            <a href="#" class="section-icon-btn"><img src="/src/images/arrow-white.svg" alt=""/></a>
                        </div>
                    </div>
                    {/* <!-- Service Item End --> */}
                </div>
                    ...
                    <div class="luxury-collection-box">
                        ...
                        <div class="luxury-collection-item wow fadeInUp">
                            ...
                            <div class="luxury-collection-image" data-cursor-text="View">
                                <a href="#">
                                    <figure>
                                        <img src="/src/images/luxury-collection-img-1.jpg" alt=""/>
                                    </figure>
                                </a>
                            </div>
                        ...
                        <div class="luxury-collection-item wow fadeInUp" data-wow-delay="0.25s">
                            ...
                            <div class="luxury-collection-image" data-cursor-text="View">
                                <a href="#">
                                    <figure>
                                        <img src="/src/images/luxury-collection-img-2.jpg" alt=""/>
                                    </figure>
                                </a>
                            </div>
                            {/* <!-- Luxury Collection Image End --> */}
                        ...
                        <div class="luxury-collection-item wow fadeInUp" data-wow-delay="0.5s">
                            ...
                            <div class="luxury-collection-image" data-cursor-text="View">
                                <a href="#">
                                    <figure>
                                        <img src="/src/images/luxury-collection-img-3.jpg" alt=""/>
                                    </figure>
                                </a>
                            </div>
                            {/* <!-- Luxury Collection Image End --> */}
                        ...
                        <div class="luxury-collection-item wow fadeInUp" data-wow-delay="0.75s">
                            ...
                            <div class="luxury-collection-image" data-cursor-text="View">
                                <a href="#">
                                    <figure>
                                        <img src="/src/images/luxury-collection-img-4.jpg" alt=""/>
                                    </figure>
                                </a>
                            </div>
                            {/* <!-- Luxury Collection Image End --> */}
                     ...
                     <div class="about-footer">
                        ...
                        {/* <!-- About Footer Content Start --> */}
                         <div class="about-footer-content">
                            <p>Experience the ease and convenience of renting a car with Flash-cab. </p>
                         </div>
                        ...
                        <div class="footer-newsletter-form">
                            <form id="newslettersForm" action="#" method="POST">
                                <div class="form-group">
                                    ...
                                    <button type="submit" class="section-icon-btn"><img src="/src/images/arrow-white.svg" alt=""/></button>
                                </div>
                            </form>
                        </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-7">
                        ...
                        <div class="footer-copyright-text">
                            <p>© 2024 Flash-cab. All rights reserved.</p>
                        </div>
